...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-prisoner-finance-holds-api/security/policy).
...
## Renaming from HMPPS Prisoner Finance Holds Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-prisoner-finance-holds-api=0
```
